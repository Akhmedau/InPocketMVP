...
protocol PasscodePresenterProtocol: AnyObject{
    ...
    init(view: PasscodeViewProtocol, passcodeState: PasscodeState, keychainManager: KeychainManagerProtocol, sceneDelagate: SceneDelegate)
}
...
class PasscodePresenter: PasscodePresenterProtocol{
    ...
    var sceneDelagate: SceneDelegate
    
    required init(view: PasscodeViewProtocol, passcodeState: PasscodeState, keychainManager: KeychainManagerProtocol, sceneDelagate: SceneDelegatel) {
        self.view = view
